                                        ...
                                        <Row className="gy-4">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div className="form-floating">
                                                    <Input type="text" className="form-control" id="firstnamefloatingInput"
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            ...
                                            <Row className="g-3">
                                                ...
                                                <Col lg={6}>
                                                    <div className="input-group">
                                                        <button className="btn btn-outline-primary shadow-none" type="button" id="button-addon1">Button</button>
                                                ...
                                                <Col lg={6}>
                                                    <div className="input-group">
                                                        ...
                                                        <button className="btn btn-outline-success shadow-none" type="button" id="button-addon2">Button</button>
                                                    </div>
                                                </Col>
                                                <Col lg={6}>
                                                    <div className="input-group">
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            ...
                                            <Row className="g-3">
                                                ...
                                                <Col lg={12}>
                                                    <UncontrolledDropdown className="input-group">
                                                        <DropdownToggle tag="button" className="btn btn-outline-secondary shadow-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</DropdownToggle>
                                                        <DropdownMenu>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            ...
                                            <Row className="g-3">
                                                ...
                                                <Col lg={6}>
                                                    <div className="input-group">
                                                        <button className="btn btn-outline-primary shadow-none" type="button">Button</button>
                                                ...
                                                <Col lg={6}>
                                                    <div className="input-group">
                                                        ...
                                                        <button className="btn btn-outline-secondary shadow-none" type="button">Button</button>
                                                    </div>
                                                </Col>
                                            </Row>
                                        </div>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <Row className="g-3">
                                                ...
                                                <Col lg={6} >
                                                    <div className="input-group">
                                                        <button className="btn btn-outline-primary shadow-none" type="button" id="inputGroupFileAddon03">Button</button>
                                                ...
                                                <Col lg={6} >
                                                    <div className="input-group">
                                                        ...
                                                        <button className="btn btn-outline-success shadow-none" type="button" id="inputGroupFileAddon04">Button</button>
                                                    </div>
                                                </Col>
                                            </Row>
                                        </div>
