...
const ProfileDropdown = () => {
    ...
    return (
        <React.Fragment>
            <Dropdown isOpen={isProfileDropdown} toggle={toggleProfileDropdown} className="me-4 ms-3 header-item topbar-user" style={{backgroundColor: "#000"}}>
                <DropdownToggle tag="button" type="button" className="btn shadow-none bg-soft-dark" style={{borderRadius: "7px"}}>
                ...
                <DropdownMenu className="dropdown-menu-end">
                    ...
                    <h6 className="dropdown-header">Welcome Billy!</h6>
