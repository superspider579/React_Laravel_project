    ...
    return (
        <React.Fragment>
            ...
            <div style={{display: "none"}}>
                ...
                <Offcanvas isOpen={open} style={{display: "none"}} toggle={toggleLeftCanvas} direction="end" className="offcanvas-end border-0">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-4">
                                            <div className="form-check card-radio dark">
                                                ...
                                                />
                                                <label className="form-check-label p-0 avatar-md w-100 shadow-sm bg-dark" htmlFor="layout-mode-dark">
                                                    <span className="d-flex gap-1 h-100">
                                                        <span className="flex-shrink-0">
                                            ...
                                            <div className="row">
                                                <div className="col-4">
                                                    <div className="form-check card-radio">
                                                        ...
                                                        />
                                                        <label className="form-check-label p-0 avatar-md w-100 shadow-sm" htmlFor="layout-width-fluid">
                                                            <span className="d-flex gap-1 h-100">
                                                                <span className="flex-shrink-0">
                                                                    <span className="bg-light d-flex h-100 flex-column gap-1 p-1">
                                                                        <span className="d-block p-1 px-2 bg-soft-primary rounded mb-2"></span>
                                                ...
                                                <div className="col-4">
                                                    <div className="form-check card-radio">
                                                        ...
                                                        />
                                                        <label className="form-check-label p-0 avatar-md w-100 shadow-sm px-2" htmlFor="layout-width-boxed">
                                        ...
                                        <div className="row">
                                            <div className="col-4">
                                                <div className="form-check sidebar-setting card-radio">
                                                    ...
                                                    />
                                                    <label className="form-check-label p-0 avatar-md w-100 shadow-sm" htmlFor="sidebar-color-light">
                                                        <span className="d-flex gap-1 h-100">
                                                            <span className="flex-shrink-0">
                                            ...
                                            <div className="col-4">
                                                <div className="form-check sidebar-setting card-radio">
                                                    ...
                                                    />
                                                    <label className="form-check-label p-0 avatar-md w-100 shadow-sm" htmlFor="sidebar-color-dark">
                                                        <span className="d-flex gap-1 h-100">
                                                            <span className="flex-shrink-0">
