...
const NotificationDropdown = () => {
    ...
    return (
        <React.Fragment>
            <Dropdown isOpen={isNotificationDropdown} toggle={toggleNotificationDropdown} className="topbar-head-dropdown ms-3 header-item">
                <DropdownToggle type="button" tag="button" className="btn btn-icon btn-topbar btn-ghost-secondary bg-soft-dark shadow-none" style={{padding: "26px"}}>
                    <i className='bx bx-bell fs-22'></i>
                    <span
                        className="position-absolute fs-10 translate-middle badge rounded-pill bg-danger" style={{right: "-2px", top: "14px"}}>3<span
